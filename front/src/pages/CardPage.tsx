    ...
    return (
        <>
            <div className="w-full h-screen overflow-auto bg-slate-700 grid grid-cols-3 gap-4 card-page-container">
                {isLoading ?
                    <div className="w-screen h-screen flex self-center justify-center"><LoadingSpinner/></div>
                    :
                    <>
                        ...
                        <div
                            className="card-details-container col-span-1 bg-blue-500 h-full px-2 align-center flex justify-center items-center">
                            {cardToDisplay ?
                                <CardDetails
